...
import phuctv.InsuranceTest;

import static org.junit.jupiter.api.Assertions.*;

class InsuranceClaimTest {

    private InsuranceTest claim;

    @BeforeEach
    void setUp() {
        claim = new InsuranceTest("C001", 1000.0);
    }
    ...
    void testConstructorInvalidAmount() {
        assertThrows(IllegalArgumentException.class, () -> new InsuranceTest("C002", -500));
    }
    ...
    void testConstructorNullClaimId() {
        assertThrows(IllegalArgumentException.class, () -> new InsuranceTest(null, 1000.0));
    }
